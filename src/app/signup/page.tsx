    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: '#020617' }}>
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 text-sm mt-1">Start calculating your worth today</p>
        </div>
        ...
        {!clerkEnabled ? (
          ...
          >
            ...
            <p className="text-slate-500 text-sm">Set real Clerk keys in your environment file to enable signup.</p>
          </div>
        ) : (
          <div
